                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="flex-1 flex flex-col items-center justify-center p-6 bg-gray-900 border border-white/10 rounded-xl hover:border-brand-gold transition-colors duration-300 group">
                            ...
                            <a href="https://linkedin.com/in/nikitharao" target="_blank" rel="noopener noreferrer" className="flex-1 flex flex-col items-center justify-center p-6 bg-gray-900 border border-white/10 rounded-xl hover:border-brand-gold transition-colors duration-300 group">
