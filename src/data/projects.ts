...
export const projects: Project[] = [
  ...
  { id: '2', type: 'video', category: 'Social Media Manage', client: 'Bvlgari – Instagram Reels Campaign', src: '/media/videos/Video-746.mp4', span: 'col-span-1 row-span-2', role: 'Social Media Manager', description: 'Formulated and executed a high-engagement social strategy for Bvlgari, maintaining luxury brand consistency across all short-form content.' },
  ...
  { id: '11', type: 'video', category: 'Social Media Manage', client: 'Raw & Ruckus – Creative Reel', src: '/media/videos/Video-369.mp4', span: 'col-span-1 row-span-2', role: 'Content Creator', description: 'End-to-end production of engaging, fast-paced reels targeting Gen-Z luxury consumers.' },
